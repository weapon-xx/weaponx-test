...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_rxjs_Rx__ = __webpack_require__(71);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_rxjs_Rx___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_rxjs_Rx__);


const button = document.querySelector('button');

__WEBPACK_IMPORTED_MODULE_0_rxjs_Rx___default.a.Observable.fromEvent(button, 'click').scan(count => count + 1, 0).subscribe(count => console.log(`click ${count} time!`));

const foo = __WEBPACK_IMPORTED_MODULE_0_rxjs_Rx___default.a.Observable.create(observer => {
  setTimeout(() => {
    observer.next('async function foo end');
  }, 1000);
});

const bar = __WEBPACK_IMPORTED_MODULE_0_rxjs_Rx___default.a.Observable.create(observer => {
  setTimeout(() => {
